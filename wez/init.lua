...
return {
	...
	-- front_end = "OpenGL",
	-- front_end = "WebGpu",
	front_end = fromnix.gpuFrontEnd,
	webgpu_power_preference = fromnix.webgpu_power_preference, -- "HighPerformance", -- "LowPower",
	webgpu_preferred_adapter = nil,
	webgpu_force_fallback_adapter = fromnix.webgpu_force_fallback_adapter,
